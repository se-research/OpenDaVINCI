...
#ifndef VELODYNE16LIVE_H_
#define VELODYNE16LIVE_H_
...
namespace automotive {
         ...
         */
        class VelodyneDecoder16Live : public odcore::base::module::TimeTriggeredConferenceClientModule {
            private:
                /**
                 ...
                 */
                VelodyneDecoder16Live(const VelodyneDecoder16Live &/*obj*/);
                 ...
                 */
                VelodyneDecoder16Live& operator=(const VelodyneDecoder16Live &/*obj*/);
            ...
            public:
                 ...
                 */
                VelodyneDecoder16Live(const int32_t &argc, char **argv);

                virtual ~VelodyneDecoder16Live();
