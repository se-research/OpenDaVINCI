...
#ifndef GENERATEDHEADERS_TEST5_HELPER_H
#define GENERATEDHEADERS_TEST5_HELPER_H

#include <opendavinci/odcore/data/Container.h>
#include <opendavinci/odcore/base/Visitor.h>
#include <opendavinci/odcore/reflection/Message.h>
#include <opendavinci/odcore/reflection/Helper.h>
class GeneratedHeaders_Test5_Helper : public odcore::reflection::Helper {
    public:
        virtual ~GeneratedHeaders_Test5_Helper();
...
#endif //GENERATEDHEADERS_TEST5_HELPER_H
