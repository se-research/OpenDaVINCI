...
#ifndef GENERATEDHEADERS_TEST20_HELPER_H
#define GENERATEDHEADERS_TEST20_HELPER_H

#include <opendavinci/odcore/data/Container.h>
#include <opendavinci/odcore/base/Visitor.h>
#include <opendavinci/odcore/reflection/Message.h>
#include <opendavinci/odcore/reflection/Helper.h>
class GeneratedHeaders_Test20_Helper : public odcore::reflection::Helper {
    public:
        virtual ~GeneratedHeaders_Test20_Helper();
...
#endif //GENERATEDHEADERS_TEST20_HELPER_H
