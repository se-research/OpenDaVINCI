	...
	public:
		void testCreateObject() {
			...
			TS_ASSERT_DELTA(obj1.getValueForKey_MapOfMyInt32DoubleMap(-500), 3.0, 1e-5);
			{
				...
				TS_ASSERT(!obj1.isEmpty_MapOfMyInt32StringMap());
				TS_ASSERT(obj1.containsKey_MapOfMyInt32StringMap(-300));
				TS_ASSERT(odcore::strings::StringToolbox::equalsIgnoreCase(obj1.getValueForKey_MapOfMyInt32StringMap(-300), "Hello World!"));
				TS_ASSERT(obj1.containsKey_MapOfMyInt32StringMap(-400));
				TS_ASSERT(odcore::strings::StringToolbox::equalsIgnoreCase(obj1.getValueForKey_MapOfMyInt32StringMap(-400), "Hello Solar System!"));
				TS_ASSERT(obj1.containsKey_MapOfMyInt32StringMap(-500));
				TS_ASSERT(odcore::strings::StringToolbox::equalsIgnoreCase(obj1.getValueForKey_MapOfMyInt32StringMap(-500), "Hello Milky Way!"));
