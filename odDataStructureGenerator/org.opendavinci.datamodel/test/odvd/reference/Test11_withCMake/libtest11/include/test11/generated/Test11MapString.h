...
#ifndef TEST11MAPSTRING_H
#define TEST11MAPSTRING_H
...
class OPENDAVINCI_API Test11MapString : public odcore::data::SerializableData, public odcore::base::Visitable {
	public:
		Test11MapString();
		 ...
		 */
		Test11MapString(const Test11MapString &obj);
		 ...
		 */
		Test11MapString& operator=(const Test11MapString &obj);
