...
class Test12MapBool : public core::data::SerializableData, public core::base::Visitable {
	public:
		Test12MapBool();
		 ...
		 */
		Test12MapBool(const Test12MapBool &obj);
		 ...
		 */
		Test12MapBool& operator=(const Test12MapBool &obj);
