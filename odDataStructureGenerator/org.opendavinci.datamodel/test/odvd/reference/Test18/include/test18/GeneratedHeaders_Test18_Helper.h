...
#ifndef GENERATEDHEADERS_TEST18_HELPER_H
#define GENERATEDHEADERS_TEST18_HELPER_H

#include <opendavinci/odcore/data/Container.h>
#include <opendavinci/odcore/base/Visitor.h>
#include <opendavinci/odcore/reflection/Message.h>
#include <opendavinci/odcore/reflection/Helper.h>
class GeneratedHeaders_Test18_Helper : public odcore::reflection::Helper {
    public:
        virtual ~GeneratedHeaders_Test18_Helper();
...
#endif //GENERATEDHEADERS_TEST18_HELPER_H
