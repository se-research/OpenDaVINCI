...
class Serializable;
        ...
        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const char &v) {
            m_buffer.write(&v, sizeof(const char));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const unsigned char &v) {
            m_buffer.write(reinterpret_cast<const char*>(&v), sizeof(const unsigned char));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const int8_t &v) {
            m_buffer.write(reinterpret_cast<const char*>(&v), sizeof(const int8_t));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const int16_t &v) {
            int16_t _v = htons(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const int16_t));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const uint16_t &v) {
            uint16_t _v = htons(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const uint16_t));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const int32_t &v) {
            int32_t _v = htonl(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const int32_t));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const uint32_t &v) {
            uint32_t _v = htonl(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const uint32_t));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const int64_t &v) {
            int64_t _v = Serializer::__htonll(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const int64_t));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const uint64_t &v) {
            uint64_t _v = Serializer::__htonll(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const uint64_t));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const float &v) {
            float _v = htonf(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const float));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const double &v) {
            double _v = htond(v);
            m_buffer.write(reinterpret_cast<const char*>(&_v), sizeof(const double));
        }

        void LCMSerializerVisitor::write(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, const string &v) {
            uint32_t length = v.length();
            uint32_t _length = htonl(length);
            m_buffer.write(reinterpret_cast<const char *>(&_length), sizeof(const uint32_t));
            m_buffer.write(v.c_str(), length);
        ...
        void LCMSerializerVisitor::beginVisit(const int32_t &/*id*/, const string &/*shortName*/, const string &/*longName*/) {}
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, char &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, unsigned char &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, int8_t &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, int16_t &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, uint16_t &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, int32_t &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, uint32_t &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, int64_t &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, uint64_t &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, float &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, double &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &id, const string &longName, const string &shortName, string &v) {
            m_hash = LCMSerializerVisitor::calculateHash(m_hash, shortName);
        ...
        void LCMSerializerVisitor::visit(const uint32_t &/*id*/, const string &/*longName*/, const string &/*shortName*/, void */*data*/, const uint32_t &/*count*/, const odcore::TYPE_ &/*t*/) {
            std::cerr << "core::serialization::LCMSerializerVisitor::visit not implemented." << std::endl;
        }
