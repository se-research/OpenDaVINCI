...
#ifndef OPENDAVINCI_CORE_SERIALIZATION_LCMSERIALIZERVISITOR_H_
#define OPENDAVINCI_CORE_SERIALIZATION_LCMSERIALIZERVISITOR_H_
...
#endif /*OPENDAVINCI_CORE_SERIALIZATION_LCMSERIALIZERVISITOR_H_*/
