...
#ifndef OPENDAVINCI_CORE_SERIALIZATION_PROTODESERIALIZERVISITOR_H_
#define OPENDAVINCI_CORE_SERIALIZATION_PROTODESERIALIZERVISITOR_H_
...
#endif /*OPENDAVINCI_CORE_SERIALIZATION_PROTODESERIALIZERVISITOR_H_*/
