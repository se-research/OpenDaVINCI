...
#include "opendavinci/odcore/serialization/ROSSerializerVisitor.h"  // for ROSSerializerVisitor
...
class ROSVehicleControl : public odcore::data::SerializableData, public odcore::base::Visitable {
    ...
    void accept(odcore::base::Visitor &v) {
        ...
        v.visit(1, "ROSVehicleControl.speed", "speed", m_speed);
        v.visit(2, "ROSVehicleControl.acceleration", "acceleration", m_acceleration);
        v.visit(3, "ROSVehicleControl.steeringWheelAngle", "steeringWheelAngle", m_steeringWheelAngle);
        v.visit(4, "ROSVehicleControl.brakeLights", "brakeLights", m_brakeLights);
        v.visit(5, "ROSVehicleControl.flashingLightsLeft", "flashingLightsLeft", m_flashingLightsLeft);
        v.visit(6, "ROSVehicleControl.flashingLightsRight", "flashingLightsRight", m_flashingLightsRight);
        v.endVisit();
    }
