...
#ifndef PLAYER2NOTHREADINGTESTSUITE_H_
#define PLAYER2NOTHREADINGTESTSUITE_H_
...
class PlayerModule2NoThreadingTest : public CxxTest::TestSuite {
    public:
...
#endif /*PLAYER2NOTHREADINGTESTSUITE_H_*/
