...
class LoggerTest : public CxxTest::TestSuite {
    public:
        ...
        void testLogLevelDebug() {
            ...
            string sc_argv1("--cid=84");
            string sc_argv2("--freq=10");
            string sc_argv3("--loglevel=debug");
            string sc_argv4("--logfile=test4.log");
            int32_t sc_argc = 5;
            char **sc_argv;
