...
class LoggerTest : public CxxTest::TestSuite {
    public:
        ...
        void testLogLevelWarn() {
            ...
            string sc_argv1("--cid=83");
            string sc_argv2("--freq=10");
            string sc_argv3("--loglevel=warn");
            string sc_argv4("--logfile=test3.log");
            int32_t sc_argc = 5;
            char **sc_argv;
