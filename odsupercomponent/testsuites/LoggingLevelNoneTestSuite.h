...
class LoggerTest : public CxxTest::TestSuite {
    public:
        ...
        void testLogLevelNone() {
            ...
            string sc_argv1("--cid=81");
            string sc_argv2("--freq=10");
            string sc_argv3("--loglevel=none");
            string sc_argv4("--logfile=test1.log");
            int32_t sc_argc = 5;
            char **sc_argv;
            ...
            // The file test1.log must not exist in this test case.
            fstream fin("test1.log", ios::in);
            TS_ASSERT(!fin.good());
            fin.close();
