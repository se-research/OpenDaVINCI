...
class SupercomponentClientModuleTest : public CxxTest::TestSuite,
    ...
    public:
        ...
        void testServerSpecificDefaultConfigurationFile() {
            UNLINK("configuration");
            UNLINK("myconfiguration");
            stringstream configurationData;
            configurationData << "global.mydata = ABC" << endl;
            fstream fout("myconfiguration", ios::trunc | ios::out);
            ...
            try {
                ...
                string argv1("--cid=152");
                string argv2("--configuration=myconfiguration");
                int32_t argc = 3;
                char **argv;
                argv = new char*[3];
